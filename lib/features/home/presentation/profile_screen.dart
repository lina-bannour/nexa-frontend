          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ListTile(
                    leading: const Icon(Icons.videogame_asset_outlined, color: NexaColors.purple),
                    title: const Text(
                      'Progression',
                      style: TextStyle(fontWeight: FontWeight.w600, color: NexaColors.txt2),
                    ),
                    subtitle: const Text('Niveaux, badges, barème', style: TextStyle(fontSize: 12, color: NexaColors.txt3)),
